...
import { Search, Filter, DollarSign, CheckCircle2, Clock, XCircle } from 'lucide-react';
...
export default function AdminTransactions() {
  ...
  const loadTransactions = async () => {
    try {
      ...
      // Buscar profiles e orders separadamente
    ...
    <AppLayout>
      <div className="container mx-auto p-4 sm:p-6 max-w-full">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl sm:text-3xl font-bold">Gestão de Transações</h1>
        </div>
